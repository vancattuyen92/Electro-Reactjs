...
import sound from './WirelessSound.png'
...
const HoverableDiv = ({ handleMouseOver, handleMouseOut }) => {
  return (
    <div className='product-card'>
      ...
      <div><img src={sound} alt=''/></div>
      <div className='j-between'>
        <p className='product-price'>$2,299.00</p>
  ...
  const dateTimeAfterThreeDays = NOW_IN_MS + THREE_DAYS_IN_MS;
    ...
    return (
      <div>
        ...
        <div className='savingImage container'>
          <img src={savingImage} alt='' href='/'/>
        </div>        
